...
<section>
  ...
  <div class="space-y-3 mb-6">
    {#each scripts as script (script.id)}
      <div class="p-3 bg-base-100 rounded shadow-sm flex justify-between items-center">
        {#if script.url}
          <a
            href={script.url}
            target="_blank"
          ...
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" class="w-4 h-4"><path d="M2 3.5A1.5 1.5 0 0 1 3.5 2h6.89a1.5 1.5 0 0 1 1.06.44l2.11 2.11A1.5 1.5 0 0 1 14 5.61V12.5A1.5 1.5 0 0 1 12.5 14h-9A1.5 1.5 0 0 1 2 12.5v-9ZM10.5 3.5h-7a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5V6h-3.5A1.5 1.5 0 0 1 9 4.5V3Z"/></svg>
            {script.file_name}
          </a>
        {:else}
        ...
        <form method="POST" action="?/deleteScript" use:enhance class="inline">
          ...
          <button type="submit" class="btn btn-xs btn-ghost text-error" aria-label={`Delete script ${script.file_name}`}>Delete</button>
        </form>
      </div>
    {:else}
  ...
  <FileUploader bucketName={"project-assets"} onUploadSuccess={() => invalidateAll()} />
</section>
